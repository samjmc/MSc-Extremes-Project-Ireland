...
# Assuming you have the data for both methods in these dataframes:
# return_levels_all_block (BM method)
# return_levels_all_pot (POT method)

# Example structure:
# return_levels_all_block: station_name, return_2yr, return_5yr, return_20yr, return_100yr
# return_levels_all_pot: station_name, return_2yr, return_5yr, return_20yr, return_100yr
